...
---@field result? easy-dotnet.job.Result
...
--- A listener receives a easy-dotnet.job.Event on "started"
--- and returns a function that will be called with a easy-dotnet.job.Event on "finished"
