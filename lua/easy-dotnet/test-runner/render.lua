...
---@class easy-dotnet.test.runner.Window
---@field tree table<string,easy-dotnet.test.runner.Node>
---@field jobs table
...
---@field filter easy-dotnet.test.runner.Result
---@field keymap table
---@field options table
...
---@alias easy-dotnet.test.runner.Result '"Failed"' | '"NotExecuted"' | '"Passed"'
...
---@param node easy-dotnet.test.runner.Node | nil
---@param cb function
...
---@param tree easy-dotnet.test.runner.Node The root node of the tree structure to traverse.
---@return easy-dotnet.test.runner.Node | nil
...
---@param a easy-dotnet.test.runner.BuildJob | easy-dotnet.test.runner.DiscoverJob
...
local function node_to_string(node)
  local total_tests = 0
  ---@param i easy-dotnet.test.runner.Node
...
---@param tree easy-dotnet.test.runner.Node
---@return string[], table[]
